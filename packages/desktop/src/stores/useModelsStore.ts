...
export const models: Model[] = [
  ...
  },
  {
    ...
    title: 'BRIA RMBG 2.0',
    version: '2.0.0',
    description: 'RMBG v2.0 is a state-of-the-art background removal model, designed to effectively separate foreground from background in a range of categories and image types.',
    resolution: 1024,
    size: 1070596096,
    url: 'https://github.com/danielgatis/rembg/releases/download/v0.0.0/bria-rmbg-2.0.onnx',
    reference: 'https://huggingface.co/briaai/RMBG-2.0'
  },
  {
    name: 'u2net',
    title: 'U2-Net',
